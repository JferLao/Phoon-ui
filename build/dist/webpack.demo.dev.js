...
var MiniCssExtractPlugin = require("mini-css-extract-plugin"); //将css提取到单独的文件中,支持sourceMap按需加载


var CopyWebpackPlugin = require("copy-webpack-plugin"); //复制文件或目录


var HtmlWebpackPlugin = require("html-webpack-plugin"); //将webpack打包的嵌入到新生成的html文件内
...
var webpackConfig = {
  ...
  }), new ProgressBarPlugin(), new VueLoaderPlugin(), new webpack.DefinePlugin({
    //创建一个在编译时可以配置的全局常量
